...
const Footer = forwardRef((props, ref) => {
  ...
  const handleBtnState = () => {
    setprotfolioState(!protfolioState);
  };
    ...
    <div ref={ref} className="footer">
      <div className="bioDiv">
        ...
        <video
          ...
          loop
          muted
          className="BiobackgroundVideoMobile"
        />
        <div className="myinfo">
          <p className="myName">Ravikumar Mathad</p>
          <p className="myRole">Full Stack Developer</p>
        </div>
        <div className="bioBtns">
          <button onClick={handleBtnState} className="BioBtn">
            {protfolioState ? (
            ...
            {protfolioState ? "In progress!" : "Portfolio"}
          </button>
          <button onClick={handleResumeBtn} className="BioBtn">
            {ResumeBtn ? (
              <FontAwesomeIcon
                icon={faAnglesRight}
                style={{ color: "#000000" }}
      ...
      <div className="moreBio">
        <div className="skills">
          <ul className="skillsList">
            <li className="skillsName">Skills</li>
            <li className="IndSkills">Python Developer</li>
            <li className="IndSkills">Front-end</li>
            <li className="IndSkills">Back-end</li>
            <li className="IndSkills">DSA</li>
          </ul>
        </div>
        <div className="socialMedia">
          <ul className="example-2">
            <li className="icon-content">
              <a
                href="https://www.linkedin.com/in/ravimathad"
                aria-label="LinkedIn"
            ...
            <li className="icon-content">
              <a
                href="https://github.com/Ravikumar-Mathad"
                aria-label="GitHub"
                data-social="github"
              >
                <div className="filled"></div>
            ...
            <li className="icon-content">
              <a
                href="https://www.instagram.com/ravi_mathad7"
            ...
            <li className="icon-content">
              <a
                href="https://www.youtube.com/@Ravi_Mathad7"
                aria-label="YouTube"
                data-social="youtube"
              >
                <div className="filled"></div>
