  ...
  return (
    <div style={{ marginTop: "0px" }} className="TopratedShows">
      <div className="headlinesDiv">
        <p className="headline">Wellness Wonders</p>
        <p className="miniheadline">
          Stay motivated—explore the most inspiring fitness influencers and
          unlock tips to transform your lifestyle!
        </p>
      </div>
      <div
      ...
      >
        {Tumbnails.map((Tumbnail, index) => (
          <div className="topRatedVideo" key={Tumbnail.resourceId.videoId + "fitness"}>
            <img
            ...
            <div className="videoDetails">
              <div className="videoBtns">
                <NavLink to="/Health" state={{ videoIndex: index }}>
